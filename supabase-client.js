...
async function fetchAllRecords(table, columns = "*", batchSize = 1000, statusCallback = null) {
...
// Expose functions to window for access in popup.js
window.initializeCredentials = initializeCredentials;
window.createSupabaseClient = createSupabaseClient;
window.fetchAllRecords = fetchAllRecords;
window.getSupabase = () => supabase;
window.getSupabaseUrl = () => SUPABASE_URL;
window.getSupabaseKey = () => SUPABASE_ANON_KEY;
