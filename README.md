...
**SkipREXA** is a Chrome Extension designed to streamline the process of uploading exam question papers to ChatGPT for study and analysis. It acts as a bridge between a database of university question papers and ChatGPT's file upload interface.
...
*   **Automated Upload:** Downloads selected PDFs and automatically uploads them to the active ChatGPT conversation.
...
4.  Click **Upload** to send them to ChatGPT with a context prompt.
